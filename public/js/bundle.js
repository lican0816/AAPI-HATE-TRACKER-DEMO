...
var displayMap = function displayMap(location) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGljYW44MTYiLCJhIjoiY2twN2FkZnViMDVibzJwcXM0MnRxZWViYiJ9.CM9wK6BXCpYP6W8ZvGxi3w';
  ...
  new mapboxgl.Marker({
    element: el,
    anchor: 'bottom'
  }).setLngLat(location).addTo(map); // Add popup
...
var report = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, date, city, state, description, location) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Created report successfully!');
              window.setTimeout(function () {
                window.location.assign('/');
              }, 1500);
            }
          ...
          case 7:
            ...
            if (_context.t0.response.data.message.includes('Duplicate')) {
              (0, _alerts.showAlert)('error', 'Duplicate title.');
            } else {
              (0, _alerts.showAlert)('error', _context.t0.response.data.message);
            }
  ...
  return function report(_x, _x2, _x3, _x4, _x5, _x6) {
    return _ref.apply(this, arguments);
  };
}();
...
var makeComment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(incidentID, comment) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/incidents/".concat(incidentID, "/reviews"),
              data: {
                comment: comment
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Comment successfully!');
          ...
          case 7:
            ...
            if (_context.t0.response.data.message.includes('Duplicate')) {
              (0, _alerts.showAlert)('error', 'You already made a comment.');
            } else {
              (0, _alerts.showAlert)('error', _context.t0.response.data.message);
            }
  ...
  return function makeComment(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
if (mapBox) {
  ...
  if (!mapBox.dataset.lng || !mapBox.dataset.lat) {
    ...
    locations = [parseFloat(mapBox.dataset.lng), parseFloat(mapBox.dataset.lat)];
  }
...
if (commentForm) {
  commentForm.addEventListener('submit', function (e) {
    ...
    var incidentID = commentForm.dataset.incidentid;
    (0, _comment.makeComment)(incidentID, comments);
  });
}
...
if (reportForm) reportForm.addEventListener('submit', function (e) {
  ...
  var city = document.getElementById('city').value.replace(/\w\S*/g, function (w) {
    return w.replace(/^\w/, function (c) {
      return c.toUpperCase();
    });
  });
  var state = document.getElementById('state').value;
  var latitude = document.getElementById('lat').value || 0;
  var longitude = document.getElementById('lng').value || 0;
  var description = document.getElementById('description').value;
  var dateToCompare = date.split('-');
  dateToCompare = new Date(dateToCompare[0], dateToCompare[1] - 1, dateToCompare[2]);

  if (dateToCompare.getTime() > Date.now()) {
    return (0, _alerts.showAlert)('error', 'Date can not be beyond today.');
  }
  ...
  (0, _report.report)(name, date, city, state, description, location);
});
